...
- (void)getWeather:(CLLocation *)location {
    if (weatherCalled == 0) {
        ...
        //WEATHER CASES
        if(60 < weather.Fvalue && ([weather.currentDescription rangeOfString:@"Sunny" options:NSCaseInsensitiveSearch].location != NSNotFound)) {
        ...
        //Mist and fog
        else if(60 <= weather.Fvalue && (([weather.currentDescription rangeOfString:@"Mist" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Fog" options:NSCaseInsensitiveSearch].location != NSNotFound))) {
        ...
        //Patchy rain nearby
        else if(50 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Patchy rain nearby" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        //Patchy snow nearby
        else if(15 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Patchy snow nearby" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        //Patchy sleet nearby
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Patchy sleet nearby" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Freezing drizzle" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(40 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Thundery" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        //Blowing snow
        else if(10 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Blowing snow" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        //Blizzard
        else if(10 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Blizzard" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(50 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Light drizzle" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(40 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Light rain" options:NSCaseInsensitiveSearch].location != NSNotFound) {
            UIImage *LightRain1 = [UIImage imageNamed:@"LightRain1.png"];
            [_mamaSays setImage:LightRain1];
        }
        //freezing rain
        else if(40 > weather.Fvalue && (([weather.currentDescription rangeOfString:@"Light rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"light freezing rain"].location != NSNotFound))) {
        ...
        else if(40 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Moderate rain" options:NSCaseInsensitiveSearch].location != NSNotFound) {
            UIImage *ModerateRain1 = [UIImage imageNamed:@"ModerateRain1.png"];
            [_mamaSays setImage:ModerateRain1];
        }
        else if(40 > weather.Fvalue && (([weather.currentDescription rangeOfString:@"Moderate rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"moderate freezing rain"].location != NSNotFound))) {
        ...
        else if(40 <= weather.Fvalue && (([weather.currentDescription rangeOfString:@"Heavy rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Torrential rain" options:NSCaseInsensitiveSearch].location != NSNotFound))) {
            UIImage *HeavyRain1 = [UIImage imageNamed:@"HeavyRain1.png"];
            [_mamaSays setImage:HeavyRain1];
        }
        //freezing rain
        else if(40 > weather.Fvalue && (([weather.currentDescription rangeOfString:@"Torrential rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Heavy rain" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Heavy freezing rain"].location != NSNotFound))) {
        ...
        else if(20 <= weather.Fvalue && (([weather.currentDescription rangeOfString:@"Light snow" options:NSCaseInsensitiveSearch].location != NSNotFound) || ([weather.currentDescription rangeOfString:@"Light sleet" options:NSCaseInsensitiveSearch].location != NSNotFound))) {
        ...
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Moderate or heavy sleet" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Moderate snow" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"Heavy snow" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        ...
        else if(20 <= weather.Fvalue && [weather.currentDescription rangeOfString:@"ice pellets" options:NSCaseInsensitiveSearch].location != NSNotFound) {
